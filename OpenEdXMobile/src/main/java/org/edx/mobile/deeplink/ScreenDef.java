...
import static org.edx.mobile.deeplink.Screen.DISCUSSION_POST;
...
@StringDef({COURSE_DASHBOARD, COURSE_VIDEOS, COURSE_DISCUSSION, PROGRAM, ACCOUNT, PROFILE,
        COURSE_DISCOVERY, PROGRAM_DISCOVERY, DISCUSSION_POST})
